...
@php
    ...
    $roles          = Spatie\Permission\Models\Role::orderBy('name', 'desc')->get()->toArray();
                                            ...
                                            <div class="wt-checkboxholder">
                                                <span class="wt-checkbox">
                                                    <input id="termsconditions" type="checkbox" name="termsconditions" checked="">
                                                     <label for="termsconditions"><span>I Accept The <a href="/page/privacy-policy" target="_blank">Terms And Conditions</a></span></label>
